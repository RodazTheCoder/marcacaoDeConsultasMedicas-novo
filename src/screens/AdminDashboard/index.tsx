  ...
  return (
    <Container>
      ...
      <ScrollContainer>
        ...
        {/* Botão de Voltar no estilo original (usando signOut) */}
        <Button
          title="Voltar"
          onPress={signOut} // Reutiliza a lógica de logout do original
          containerStyle={{ marginTop: 16, marginBottom: 16, width: '100%' }}
